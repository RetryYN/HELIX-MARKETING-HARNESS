...
@pytest.mark.skip(reason="test-first DU-02: claim")
...
@pytest.mark.skip(reason="test-first DU-02: issue_strategic_brief")
...
@pytest.mark.skip(reason="test-first DU-02: validate_strategic_brief")
...
@pytest.mark.skip(reason="test-first: du-contracts DU-02 / generate_tactical_learning_packet")
...
@pytest.mark.skip(reason="test-first DU-02: get_tactical_learning_packet")
def test_get_tactical_learning_packet_returns_record_or_none() -> None:
    """du-contracts DU-02 の契約観点を検証する（実装スライスで red→green）。"""
    raise NotImplementedError


@pytest.mark.skip(reason="test-first: du-contracts DU-02 / issue_strategic_brief/supersede_strategic_brief")
