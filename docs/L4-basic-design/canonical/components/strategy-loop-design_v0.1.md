...
> pair: [strategy-loop-test-design_v0.1.md](../../integration-tests/strategy-loop-test-design_v0.1.md)（戦略層テスト設計 — HELIX 式文書ペア）
> 上位文書: [strategy-loop-requirements_v0.1.md](../../../L3-system-requirements/canonical/strategy/strategy-loop-requirements_v0.1.md)（SR）／
> [strategy-learning-contract_v0.1.md](../../../L3-system-requirements/canonical/strategy/strategy-learning-contract_v0.1.md)（契約 3 本）
> 機械可読正本: [json/strategy-components.json](strategy-components.json)（SCM 台帳）
