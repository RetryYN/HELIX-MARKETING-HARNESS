...
| 正本 | `docs/planning/drafts/L0-ai-editing-freedom-draft.md`（PR #48 merge 済み、G0.5 判断待ち）と `docs/requirements/authority.md`（#73 要求再整理） | `docs/planning/Graphix_NEO_Project_Proposal_v0.2.md`（企画書 v0.2、L0 入力。intake policy は未作成） |
