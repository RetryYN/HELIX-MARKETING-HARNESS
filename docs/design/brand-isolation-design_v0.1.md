...
> 正準参照: 要求の正準は BR-I1（[json/br/br-contracts.json](../requirements/json/br/br-contracts.json)）・
> REQ-046・FR-34（[json/fr/fr-contracts.json](../requirements/json/fr/fr-contracts.json)）。
> スキーマの正準は [s0-contract_v0.1.md §2](../requirements/s0-contract_v0.1.md)
> （`business_profiles` と FK スコープ列 — DDL は再掲しない）。
> 上位設計: [basic-design_v0.1.md](basic-design_v0.1.md)／[db-design_v0.1.md](db-design_v0.1.md)
