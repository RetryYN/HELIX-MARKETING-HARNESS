...
> pair: [integration-test-design_v0.1.md](integration-test-design_v0.1.md)（②↔④ 文書ペアの増補側 — 拒否系 ITC/TC の分類根拠）
> 上位文書: [basic-design_v0.1.md](basic-design_v0.1.md)（§4 エラー 3 系正規化）／
> [s0-contract_v0.1.md](../requirements/s0-contract_v0.1.md)（**状態遷移表・イベント分類の正準** — 本書は重複記述せず参照で書く）
> 抽出元: [json/fr/fr-contracts.json](../requirements/json/fr/fr-contracts.json)・
> [json/ac/ac-contracts.json](../requirements/json/ac/ac-contracts.json) の error_type 全数（AC 155 件走査）
> 兄弟文書: [external-if-design_v0.1.md](external-if-design_v0.1.md)（ConnectorError 境界型）／
> [approval-design_v0.1.md](approval-design_v0.1.md)（承認系分類の運用正準）
...
kind 列は [external-if-design_v0.1.md](external-if-design_v0.1.md) §3.1 の ConnectorError.kind への正規化先。
