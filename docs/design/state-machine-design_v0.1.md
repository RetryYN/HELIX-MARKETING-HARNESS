...
> [json/s0/transitions.json](../requirements/json/s0/transitions.json) ＋
> [s0-contract_v0.1.md §3](../requirements/s0-contract_v0.1.md)（§3.3 = 強制終了からの再開規則）。
> 本書は遷移表を再掲しない — 状態図・ガード分類・発火権限・競合制御・終端処理の設計だけを確定する。
> 上位設計: [basic-design_v0.1.md](basic-design_v0.1.md)（CMP-01/02）／
> [detailed-design_v0.1.md](detailed-design_v0.1.md)（DU-01/02）
