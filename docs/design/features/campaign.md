...
> 正準参照: 要求 = BR-I5（[br-contracts.json](../../requirements/json/br/br-contracts.json)）・REQ-050・
> SR-06/SR-14（[sr-contracts.json](../../requirements/json/strategy/sr-contracts.json)）。
> 役割語彙 = [media-roles.json](../../requirements/json/strategy/media-roles.json)（12 役割台帳）。
> スキーマ = [s0-contract_v0.1.md §2](../../requirements/s0-contract_v0.1.md)（`strategic_briefs`・`sprints`・`tactical_learning_packets` — DDL 再掲禁止）。
> 上位設計: [strategy-loop-design_v0.1.md](../strategy-loop-design_v0.1.md)（brief 発注経路）／[basic-design_v0.1.md](../basic-design_v0.1.md)
