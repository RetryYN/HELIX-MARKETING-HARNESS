...
> 正準参照: migration 規則（expand/backfill/contract・昇格手順）の正準は
> [s0-contract_v0.1.md §5](../../requirements/s0-contract_v0.1.md)、設計判断の上位は
> [db-design_v0.1.md §4・§6](../db-design_v0.1.md)。API 署名の正本は
> [detailed-design_v0.1.md DU-11](../detailed-design_v0.1.md)。本書は規則を再掲しない —
...
- migration 0001 は s0-contract §2 の正準 DDL と等価（G-DDL-APPLY／G-DDL-SYNC が JSON 正本
  [json/s0/ddl.sql](../../requirements/json/s0/ddl.sql) との等価性を機械検査 — 手書き同期に依存しない）。
