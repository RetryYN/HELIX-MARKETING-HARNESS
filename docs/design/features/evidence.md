...
> [s0-contract_v0.1.md §2.1](../../requirements/s0-contract_v0.1.md)、外部操作の順序契約は同 §1（NFR-3）、
> テーブル所有・append-only トリガは [db-design_v0.1.md §2〜3](../db-design_v0.1.md)。
> API 署名の正本は [detailed-design_v0.1.md DU-08/DU-09](../detailed-design_v0.1.md)。
...
- **append-only**: evidence への UPDATE/DELETE は DB トリガが常時拒否
  （[db-design_v0.1.md §3.2](../db-design_v0.1.md) トリガ 3–4）。DU-09 は read/INSERT API のみを公開し、
