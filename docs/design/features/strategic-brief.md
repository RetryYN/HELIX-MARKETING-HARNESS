...
> 正準参照: 発注契約の正準は
> [strategy-learning-contract_v0.1.md §1](../../requirements/strategy-learning-contract_v0.1.md)
> （§1.2bis = digest 算出規則）、DDL・保護トリガは
> [s0-contract_v0.1.md §2](../../requirements/s0-contract_v0.1.md)、schema は
> [json/strategy/strategic-brief.schema.json](../../requirements/json/strategy/strategic-brief.schema.json)。
> API 署名の正本は [detailed-design_v0.1.md DU-02](../detailed-design_v0.1.md)。本書は
...
- DU-01 の start ガード G3（[state-machine-design_v0.1.md §2](../state-machine-design_v0.1.md)）が
