...
- **trace**: AC = AC-21-1 AC-21-2 AC-21-3 AC-21-4 AC-44-1 AC-44-2 AC-44-3 ／ TC = TCC-21-2 TCC-44-2 ／ UT = test_gates_publish.py::test_check_publishable_all_conditions_returns_pairpass test_gates_publish.py::test_check_publishable_without_pair_rejected test_gates_publish.py::test_check_publishable_hash_mismatch_rejected test_gates_publish.py::test_check_publishable_missing_evidence_rejected test_gates_publish.py::test_check_publishable_rejection_precedes_connector_call ／ 機能別設計 = features/campaign.md
...
- **trace**: AC = AC-28-1 AC-28-2 AC-28-3 AC-28-4 ／ TC = TCC-28-1 TCC-28-2 TCC-28-3 ／ UT = test_gates_evidence_check.py::test_check_complete_all_required_kinds_pass test_gates_evidence_check.py::test_check_complete_missing_kind_rejected test_gates_evidence_check.py::test_check_complete_kind_rule_violation_rejected test_gates_evidence_check.py::test_check_complete_unknown_required_kind_fail_close ／ 機能別設計 = features/evidence.md
...
- **依存 API**: なし
- **trace**: AC = AC-71-1 AC-71-2 AC-71-3 AC-71-4 ／ TC = TCC-71-3 ／ UT = test_db_connect.py::test_connect_sets_foreign_keys_on test_db_connect.py::test_connect_sets_wal_and_busy_timeout test_db_connect.py::test_connect_configures_row_factory test_db_connect.py::test_connect_missing_protection_trigger_fatal test_db_connect.py::test_connect_unmigrated_db_fatal test_db_connect.py::test_connected_db_append_only_trigger_blocks_update_delete ／ 機能別設計 = features/migration.md
...
- **trace**: AC = AC-41-1 AC-41-2 AC-41-3 AC-41-4 AC-41-5 ／ TC = TC-041 TCC-41-1 TCC-41-2 TCC-41-3 ／ UT = test_registry_resolver.py::test_resolve_priority_order_mcp_first test_registry_resolver.py::test_resolve_switch_by_config_insert_only test_registry_resolver.py::test_unregistered_service_route_not_registered test_registry_resolver.py::test_paid_route_denied_without_exception test_registry_resolver.py::test_x_browser_write_route_prohibited test_registry_resolver.py::test_list_declared_readonly_and_schema_failclose ／ 機能別設計 = external-operations.md
...
- **依存 API**: DU-10: connect()／DU-12: get()
- **trace**: AC = AC-47-1 AC-47-2 AC-47-3 AC-47-4 ／ TC = TC-047 TCC-47-1 TCC-47-2 TCC-47-3 ／ UT = test_registry_secrets.py::test_secret_repr_and_exception_masked test_registry_secrets.py::test_get_credential_unavailable_fail_close test_registry_secrets.py::test_endpoint_mismatch_rejected_before_connect test_registry_secrets.py::test_scan_repo_sqlite_logs_zero_plaintext test_registry_secrets.py::test_scan_finding_contains_no_plaintext test_registry_secrets.py::test_mask_patterns_from_config ／ 機能別設計 = external-operations.md、brand-isolation.md
...
- **trace**: AC = AC-54-1 AC-54-2 AC-54-3 AC-54-4 AC-55-1 AC-55-2 AC-55-3 ／ TC = TC-054 TCC-54-1 TCC-54-2 TCC-54-3 ／ UT = test_content_versioning.py::test_commit_returns_valid_40_or_64_hex_hash test_content_versioning.py::test_link_records_commit_hash_evidence test_content_versioning.py::test_link_39_digit_hash_rejected test_content_versioning.py::test_link_rerun_converges_to_single_row test_content_versioning.py::test_restore_reproduces_reviewed_source ／ 機能別設計 = evidence.md、campaign.md
