...
| [L6-feature-design](docs/L6-feature-design/) | 機能別設計 | [S0 の 10 本](docs/L6-feature-design/S0/)（brief・TLP・証跡・migration・状態機械・ペア判定・ブランド隔離基盤・KPI handoff・外部操作・承認 — すべて confirmed）＋[S0.1 計画](docs/L6-feature-design/S0/plan-s0.1.json)、[S1 の 3 本](docs/L6-feature-design/S1/)（ブランド隔離完成・キャンペーン・戦略改訂 — planned）。later は空 |
